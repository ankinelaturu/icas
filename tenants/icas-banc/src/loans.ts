/**
 * @file Deterministic synthetic loan records and payoff math for icas-banc.
 *
 * Same book of business as icas-bank / Loki so typed capability inputs still
 * work. Fake accounts only — no real PII.
 */
